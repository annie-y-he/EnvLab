...
import archGlow from "~/assets/archGlow.png";
  ...
  data() {
    return {
      fishEnv: [
        ...
        //{ path: argo, glow: argoGlow, name: "argo", x: -0.5, y: 0.3, z: 0.2, s: 1.3, r: 0, vr: 0, av: 3, sel: false }, 
        { path: bag, glow: bagGlow, name: "bag", x: -0.7, y: -0.25, z: 0.3, s: 1.2, r: -15, vr: 0.06, av: 2, sel: false }, 
        //{ path: arch, glow: archGlow, name: "arch", x: 0.65, y: -0.3, z: 0.4, s: 0.5, r: 0, vr: 0.0125, av: 1, sel: false }, 
        // { path: iceberg, glow: icebergGlow, name: "iceberg", x: 0.4, y: -0.6, z: 0.5, s: 0.9, r: 20, vr: 0, av: -1, sel: false }, 
        //{ path: manatees, glow: manateesGlow, name: "manatees", x: 0.55, y: 0.35, z: 0.6, s: 1.5, r: 25, vr: 0, av: -2, sel: false }, 
        { path: pyramids, glow: pyramidsGlow, name: "pyramids", x: 0, y: -0.1, z: 0.7, s: 1.9, r: -20, vr: 0.06, av: -1, sel: false }, 
