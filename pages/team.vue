...
export default {
  ...
  data() {
    return {
      fishEnv: [
        { path: ball, glow: ballGlow, name: "ball", x: 0.09, y: 0.45, z: 0.1, s: 1.2, r: 0, vr: 0.06, av: 5, sel: false }, 
        ...
        { path: manatees, glow: manateesGlow, name: "manatees", x: 0.55, y: 0.35, z: 0.6, s: 1.5, r: 25, vr: 0.06, av: -2, sel: false }, 
